...
export default function Signup() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-white">
      <div className=" bg-white px-12 pt-12 pb-10 text-left md:w-5/12 lg:w-5/12 xl:w-4/12 ">
        <div className="m-auto w-1/2">
          <img src={DesignTeamwork} alt="team work svg" />
        </div>
        <h3 className="mb-2 pb-3 text-center text-h5  font-bold text-zinc-900 ">
          Create New Account
        </h3>
        <p className="text-sm mb-4">
          Already A Member? <a href="#" className="text-blue-600 hover:underline">
            Login
          </a>
        </p>
